...
- **Inline terminal images** — renders Kitty graphics, Sixel, and iTerm image output from modern CLI tools, preserving Kitty images across redraws and viewport resizes
