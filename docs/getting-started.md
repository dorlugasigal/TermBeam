...
For a walkthrough of the terminal UI — tabs, split view, search, touch controls, and more — see the [Usage Guide](usage-guide.md).
...
- **[Usage Guide](usage-guide.md)** — tabs, split view, search, touch controls, themes, and more
